...
class DiabetesRegistedController extends \yii\web\Controller  {
...
// default value
            ...
            $sql="SELECT * FROM 
                        ...
                        WHERE NOT ISNULL(c.DM_DX) 
                        AND YEAR(c.DM_DATE_DX)='".$year_id."' 
...
//            'sex'=>$sex,
    ...
    // บัญชีรายชื่อ
        ...
        {
        $sql="SELECT c.HN_HMAIN,c.CID,c.`NAME`,c.LNAME,c.BIRTH,c.SEX,c.HOUSE,c.VILLAGE_ID,c.DM_DATE_DX,c.HT_DATE_DX,c.DM_TYPEDISCH,c.DISCHARGE
                FROM $persontable p 
...
// admin or member is owner data
        ...
        $sql="SELECT HOSPCODE,HOSPNAME
                ,CID,`NAME`,LNAME,BIRTH,HOUSE,VILLAGE_ID,DM_DATE_DX,HT_DATE_DX,DM_TYPEDISCH
