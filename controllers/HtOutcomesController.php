...
class HtOutcomesController extends \yii\web\Controller  {
    ...
    public function actionIndex()
        ...
        $sql="SELECT * FROM 
            ...
            ,count(*) AS TOTAL
            ,sum(if(SBP0<140 AND SBP1<140 AND DBP0< 90 AND DBP1 < 90  ,1,0 )) AS RESULT1
            ,FORMAT(((sum(if(SBP0<140 AND SBP1<140 AND DBP0< 90 AND DBP1 < 90  ,1,0 )))/count(*)*100),2) AS RATE
            ,sum(if(SBP0 >139 OR SBP1 >139 OR DBP0> 89 OR DBP1 > 89 ,1,0)) AS RESULT0
