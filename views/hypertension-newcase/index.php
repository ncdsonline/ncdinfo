...
<div class="box box-success box-solid">
        <div class=" box-header">
            <h4>ผู้ป่วยโรคความดันโลหิตสูงรายใหม่</h4>
        </div>   
    ...
    echo GridView::widget([
       ...
       // 'hover' => true,
        ...
        'beforeHeader' => [
            [
                'columns' => [
                    ['content' => 'จำนวนผู้ป่วยโรคความดันโลหิตสูงรายใหม่', 'options' => ['colspan' => 12
        ...
        'columns' => [
            [
                ...
                'format' => 'raw',
                'value' => function ($data) {
                    return Html::a(Html::encode($data['HOSPCODE']), ['hypertension-newcase/view','HOSPCODE'=>$data['HOSPCODE']]);
                },
