...
<?php
$this->params['breadcrumbs'][] = ['label' => 'อัตราความชุกโรคความดันโลหิตสูง'];
?>
...
if (isset($dataProvider))
    echo \kartik\grid\GridView::widget([
        ...
        'beforeHeader' => [
            [
                'columns' => [
                    ['content' => 'อัตราความชุกโรคความดันโลหิตสูง', 'options' => ['colspan' => 9
...
//    // ตั้งแต่บ่ายยันสี่ทุ่ม  
                    ...
                    return Yii::$app->user->identity->profile->office_id == $data['HOSPCODE'] ?
                            Html::a('คลิ๊ก!ที่นี่', Yii::$app->urlManager->createUrl(['htprevalence/view', 'HOSPCODE' => $data['HOSPCODE']])) : 'ไม่อนุญาต';
