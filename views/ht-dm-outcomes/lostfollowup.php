...
$this->title = 'HT with DM Lost Follow-up';
...
<div class="box box-success box-solid">
    ...
    <div class="box-header">
                <h4><?php echo 'ผู้ป่วยโรคความดันโลหิตสูง(มีเบาหวานร่วมด้วย)ขาดการติดตาม'. '&nbsp;&nbsp;หน่วยบริการ  :'.'&nbsp;&nbsp;'.Yii::$app->user->identity->profile->office_id; ?></h4>
    </div> 
                    ...
                    echo GridView::widget([
                       ...
                       // 'hover' => true,
                        ...
                        'beforeHeader' => [
                            [
                                'columns' => [
                                    ['content' => 'ผู้ป่วยโรคความดันโลหิตสูง(มีเบาหวานร่วมด้วย)ที่ขาดการติดตาม ', 'options' => ['colspan' => 12
