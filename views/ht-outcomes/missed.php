...
<div class="box box-success box-solid">
    ...
    <div class="box-header">
                <h4><?php echo 'ผู้ป่วยโรคความดันโลหิตสูง (ไม่มีเบาหวาน) ควบคุมความดันไม่ได้'. '&nbsp;&nbsp;หน่วยบริการ  :'.'&nbsp;&nbsp;'.Yii::$app->user->identity->profile->office_id; ?></h4>
    </div> 
                    ...
                    echo GridView::widget([
                       ...
                       // 'hover' => true,
                        ...
                        'beforeHeader' => [
                            [
                                'columns' => [
                                    ['content' => 'ผู้ป่วยโรคความดันโลหิตสูงที่ควบคุมความดันไม่ได้ ', 'options' => ['colspan' => 12
