...
$this->params['breadcrumbs'][] = 'อัตราความชุกโรคเบาหวานรายหมู่บ้าน';
?>
            ...
            'value' => function ($data) {
                ...
                return !empty(Yii::$app->user->identity->profile->office_id)?
                    Html::a('<i class="glyphicon glyphicon-eye-open"></i>'
                        ,Yii::$app->urlManager->createUrl(['dmprevalence/list','HOSPCODE'=>Yii::$app->user->identity->profile->office_id])
                    ):'';
            },
            ],
